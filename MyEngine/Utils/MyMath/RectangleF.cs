...
namespace MyEngine.Utils.MyMath
{
    /// <summary>
    ...
    public struct RectangleF : IEquatable<RectangleF>
    {
        ...
        /// the center pofloat will be rounded down.
        /// </remarks>
        ...
        /// </summary>
        /// <param name="x">The x coordinate of the pofloat to check for containment.</param>
        /// <param name="y">The y coordinate of the pofloat to check for containment.</param>
        ...
        /// <returns><c>true</c> if other <see cref="RectangleF"/> floatersects with this rectangle; <c>false</c> otherwise.</returns>
        ...
        /// </summary>
        /// <param name="value">The other rectangle for testing.</param>
        /// <param name="result"><c>true</c> if other <see cref="RectangleF"/> floatersects with this rectangle; <c>false</c> otherwise. As an output parameter.</param>
        ...
        public static void Intersect(ref RectangleF value1, ref RectangleF value2, out RectangleF result)
        {
            ...
            {
                float right_side = System.Math.Min(value1.X + value1.Width, value2.X + value2.Width);
                float left_side = System.Math.Max(value1.X, value2.X);
                float top_side = System.Math.Max(value1.Y, value2.Y);
                float bottom_side = System.Math.Min(value1.Y + value1.Height, value2.Y + value2.Height);
        ...
        {
            float x = System.Math.Min(value1.X, value2.X);
            float y = System.Math.Min(value1.Y, value2.Y);
